...
import '../provider/selected_row_index.dart';
...
class EvDashboardScreen extends StatefulWidget {
  ...
  String userId;
  EvDashboardScreen({Key? key, this.callbackFun, required this.userId})
      : super(key: key);
                                                                  ...
                                                                  return DataRow2(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        String
                                                                            cityName;
                                                                        cityName =
                                                                            await getCityFromString(projectNameCol[index].toString());

                                                                        getDepoName(cityName)
                                                                            .whenComplete(() {
                                                                      ...
                                                                      cells: [
                                                                        DataCell(
                                                                            Text(projectNameCol[index].toString())),
                                                                        DataCell(
                                                                            Text('${plannedChargersCol[index].toString()} Nos')),
                                                                        DataCell(
                                                                            Text('${chargersComissioned[index].toString()} Nos')),
                                                                      ]);
                                                                })),
                                                          ),
                                                          Container(
                                                            child: PieChart(
                                                              dataMap: {
                                                                dashboardColNames[
                                                                    ...
                                                                    isExcelSelected
                                                                        ? double.parse(
                                                                            chargersComissioned[totalForAllCol])
                                                                        : 0,
                                                                dashboardColNames[
                                                                        3][2]:
                                                                    isExcelSelected
                                                            ...
                                                            child: DataTable2(
                                                                ...
                                                                rows: List.generate(
                                                                  ...
                                                                  return DataRow2(
                                                                      ...
                                                                      cells: [
                                                                        DataCell(
                                                                            Text(formatNum(double.parse(infraAmountCol[index])))),
                                                                        DataCell(
                                                                            Text(formatNum(double.parse(evChargersAmountCol[index])))),
                                                                        DataCell(
                                                                            Text(formatNum(double.parse(totalApprovedJmrAmountCol[index])))),
                                                                        DataCell(
                                                                            Text(formatNum(double.parse(totalPendingJmrAmountCol[index])))),
                                                                      ]);
                                                                })),
                                                          ),
                                                          PieChart(
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child: DataTable2(
                                                                        ...
                                                                        headingTextStyle: TextStyle(letterSpacing: 0.5, color: white, fontSize: tableHeadingFontSize),
                                                                        headingRowHeight: 25,
                                                                        dataTextStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: tableDataFontSize, color: black),
                                                                        columnSpacing: 2,
                                                                        ...
                                                                        rows: List.generate(tprelBudgetColLen, (index2) {
                                                                          return DataRow2(
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                        PieChart(
                                                                      dataMap: {
                                                                        budgetActualBottomValue[index1][0]: isExcelSelected
                                                                            ? index1 == 0
                                                                                ? double.parse(tprelBudgetCol[totalForAllCol])
                                                                                : double.parse(actualExpenseTprelCol[totalForAllCol])
                                                                            : 0,
                                                                        budgetActualBottomValue[index1][1]: isExcelSelected
                                                                            ? index1 == 0
                                                            ...
                                                            Container(
                                                              ...
                                                              child: DataTable2(
                                                                  ...
                                                                  rows: List.generate(
                                                                      ...
                                                                      (index) {
                                                                    return DataRow2(
                                                                        color: index == Provider.of<SelectedRowIndexModel>(context, listen: true).selectedRowIndex
                                                                            ? const MaterialStatePropertyAll(Color.fromARGB(
                                                                                255,
                                                                                190,
                                                                                226,
                                                                        ...
                                                                        cells: [
                                                                          DataCell(
                                                                              Text(formatNum(double.parse(assetCapitalisedTprelCol[index].toString())))),
                                                                          DataCell(
                                                                              Text(formatNum(double.parse(assetCapitalisedTpevslCol[index].toString())))),
                                                                          DataCell(
                                                                              Text(formatNum(double.parse(cumulativeAssetCapitalizedCol[index].toString())))),
                                                                          DataCell(
                                                                              Text(formatNum(double.parse(pendingAssetCapitalisationCol[index].toString())))),
                                                                        ]);
                                                                  })),
                                                            ),
                                                            PieChart(
                                                                dataMap: {
                                                                  assetCapitalisedLegendNames[
                                                                      ...
                                                                      isExcelSelected
                                                                          ? double.parse(
                                                                              cumulativeAssetCapitalizedCol[totalForAllCol])
                                                                          : 0,
                                                                  assetCapitalisedLegendNames[
                                                                          1]:
                                                                      isExcelSelected
                                                                          ? double.parse(
                                                                              pendingAssetCapitalisationCol[totalForAllCol])
                                                                          : 0,
                                                                },
                                                                legendOptions:
                                                                    const LegendOptions(
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return RichText(
                                                                        text: TextSpan(
                                                                            children: [
                                                                          TextSpan(
                                                                              text: assetCapitalisationBottomValue[index],
                                                                              style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: black)),
                                                                          const WidgetSpan(
                                                                              child: SizedBox(
                                                                            width:
                                                                          ...
                                                                          TextSpan(
                                                                              text: isExcelSelected ? formatNum(double.parse(assetTotalList[index].toString())) : '0',
                                                                              style: TextStyle(fontSize: 9, color: blue, fontWeight: FontWeight.bold))
                                                                        ]));
                                                                  }),
                                                        )
                                      ...
                                      return DataTable2(
                                          ...
                                          rows: List.generate(
                                            ...
                                            return DataRow2(cells: [
                                              ...
                                              DataCell(Text(
                                                  selectedDepoList[index])),
                                              DataCell(Text(
                                                  '${depotProgressList[index].toStringAsFixed(1)}%')),
                                              DataCell(
                                                  Text(startDateList[index])),
                                              DataCell(
                                                  Text(endDateList[index])),
                                              DataCell(Text(
                                                  estimatedDateList[index])),
                                              DataCell(Text(
